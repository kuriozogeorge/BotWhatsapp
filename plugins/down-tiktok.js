...
let handler = async (m, { conn, args, usedPrefix, command }) => {
 if (args.length < 1) throw `Ingresa al link del video de tiktok !!\n\nUtiliza ${usedPrefix+command} _Link-TikTok_`
 if (!isUrl(args[0])) throw `Ingresa al link del video de tiktok !!\n\nUtiliza ${usedPrefix+command} _Link-TikTok_`
...
♪ *Descripción :* ${res.title}
♪ *Url :* ${res.url}
♪ *Calidad :* ${res.medias[1].quality}
♪ *Tamaño :* ${res.medias[1].formattedSize}`, m)
} catch {
