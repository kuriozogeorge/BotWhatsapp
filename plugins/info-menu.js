...
*◔🤖 Propietario : @${owner[0]}*
     ...
     *﹝ᴛɪᴍᴇ ɪɴғᴏ﹞*
*◔⏱️ Date : %week %weton, %date*
*◔⏱️ Date - islamic : %dateIslamic*
...
%readmore`.trimStart(),
  header: '   「 *%category* 」   \n',
  body: '  ◍-͓ͯ҈҈҈҉҉҉҉҈҈҈҈҈҉҉҉҉҈҈҈҉҉҉҈҈҈҉҉҉҈҈҈҈҉҉҉҉҉҉҉҉҉҉҉҉҉҉҉҉҉҉҉҉҉҉҉҉҉҉҉҉҉҉҉҈҈҈҈҈҈҈̫̫   *%cmd*',
  footer: '\n',
  after: ``,
}
...
let sortedCmd = Object.entries(global.db.data.stats).map(([key, value]) => {
  ...
  sall += i.success
    ...
    var options = {
      hour: 'numeric', minute: 'numeric', second: 'numeric',day: 'numeric',month: 'long',year: 'numeric',
      timeZone: 'America/Mexico_City',
      timeZoneName: 'short'
    };
    let dateIslamic = Intl.DateTimeFormat("es-ES", {options}).format(d);
    ...
    conn.sendButtonLoc(m.chat, pRandom(arr), text, conn.menu?.after || defaultMenu.after || '© Botcito', 'TABLERO ', _p+'dashboard')
     

   } catch (e) {
    conn.reply(m.chat, 'Lo siento, el menú es un error', m)
    throw e
  }
}
